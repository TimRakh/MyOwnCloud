...
import com.timurka.MyOwnCloud.service.impl.FileServiceImpl;
import com.timurka.MyOwnCloud.service.impl.SecurityAuthServiceImpl;
...
class FileServiceImplTest {
    ...
    void testShowSavedFile() {
        ...
        List<FileData> result = fileServiceImpl.showSavedFile(1);
        Assertions.assertEquals(List.of(new FileData("fileName", 1L)), result);
    }
