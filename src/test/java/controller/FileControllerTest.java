...
import com.timurka.MyOwnCloud.controller.FileController;
...
class FileControllerTest {
    ...
    void testGetFileList(){
        when(fileService.showSavedFile(anyInt())).thenReturn(List.of(new FileData("fileName", 0L)));

        List<FileData> result = fileController.getFileList(0);
        Assertions.assertEquals(List.of(new FileData("fileName", 0L)), result);
    }
